...
Renders extracted text content from non-SSE parsed JSON responses (e.g., OpenAI chat completions) in a merged view within the JSON viewer dialog, displaying reasoning and content sections.
